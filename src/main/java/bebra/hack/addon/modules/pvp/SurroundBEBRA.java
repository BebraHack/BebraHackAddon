...
public class SurroundBEBRA extends Module {
    ...
    private final Setting<Boolean> DoubleSurNoAirPlace = sgGeneral.add(new BoolSetting.Builder().name("DoubleSurroundNoAirPlace").description("For no airplace servers.").defaultValue(true).build());
    private final Setting<Boolean> SelfTrap = sgGeneral.add(new BoolSetting.Builder().name("SelfTrap").description("Selftrap for no face place  .").defaultValue(false).build());
    ...
    private final Setting<Boolean> AntiCev = sgGeneral.add(new BoolSetting.Builder().name("AntiCev").description("Anti CevBreaker  .").defaultValue(false).build());
