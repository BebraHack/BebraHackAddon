...
public class FanSurroundBEBRA extends Module {
    ...
    public FanSurroundBEBRA() {
        super(Addon.combat, "FanSurroundBEBRA", "By MrFinka And Jabronyyy.");
    }
...
//тут вы можете добавть любой блок в сурраунд скопиров строчку ниже и поменяв название на название другого блока, например NETHERRACK на END_STONE//
