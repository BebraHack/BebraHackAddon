...
import bebra.hack.addon.Utils.CHMainUtils;
import bebra.hack.addon.Utils.SendRawMessageEvent;
...
public class ChatEncryption extends Module {
    ...
    public ChatEncryption() {
        super(Addon.chat, "chat-encryption", "Encrypts your chat messages to make them unreadable to other people.");
    }
