...
public class SurroundV2 extends Module {
    ...
    public SurroundV2() {
        super(Addon.combat, "surround-V2", "Surrounds you in blocks to prevent you from taking explosion damage.");
    }
    ...
    private void place(BlockHitResult result, Hand hand, boolean sneak) {
        if (hand != null && result != null) {
            ...
            if (placeMode.get() == PlaceMode.Packet) {
                //mc.interactionManager.sendSequencedPacket(mc.world, mc.player, sequence -> {
