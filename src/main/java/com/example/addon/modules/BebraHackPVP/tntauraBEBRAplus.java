...
public class tntauraBEBRAplus extends Module {
    ...
    private final Setting<Boolean> noairplace = sgGeneral.add(new BoolSetting.Builder().name("noairplace").description("1.12.2 placemend trap, no air place").defaultValue(false).build());
...
*/
    ...
    public tntauraBEBRAplus() {
        super(Addon.combat, "tntauraBEBRAplus", "Plece TNT in player");
    }
     ...
     */
//дописано jabronyyy and MrFiNka
