...
public class tntauraBEBRA extends Module {
    ...
    public final Setting<tntauraBEBRA.mineMode> breakMode = sgAutoBreak.add(new EnumSetting.Builder<tntauraBEBRA.mineMode>().name("break-mode").defaultValue(mineMode.Normal).visible(() -> autoBreak.get()).build());
    //pause
    ...
    public tntauraBEBRA() {
        super(Addon.combat, "tntauraBEBRA", "Plece TNT in player");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        git.action = () -> Util.getOperatingSystem().open("https://discord.gg/8zpzhvq3U7");
        return help;
    }
}
