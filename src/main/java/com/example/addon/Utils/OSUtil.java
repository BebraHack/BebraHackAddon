...
public class OSUtil {
    ...
    public static void info(String msg) {
        messageBox("Reaper " + Addon.VERSION, msg, JOptionPane.INFORMATION_MESSAGE);
    }

    public static void warning(String msg) {
        messageBox("Reaper " + Addon.VERSION, msg, JOptionPane.WARNING_MESSAGE);
    }

    public static void error(String msg) {
        messageBox("Reaper " + Addon.VERSION, msg, JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void invalidError() {
        ...
        error("You do not have an active license.\n" +
            "Visit " + Addon.INVITE_LINK + " to purchase a license.\n" +
            "If you believe this is an error, please contact support.\n" +
