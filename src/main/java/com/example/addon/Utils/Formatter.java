...
import com.example.addon.Utils.Stats;
import com.example.addon.Utils.SpotifyService;
...
public class Formatter {
    ...
    public static String applyPlaceholders(String m) {
        ...
        if (m.contains("{rversion}")) m = m.replace("{rversion}", Addon.VERSION);
        ...
        // misc
        if (m.contains("{discord}")) m = m.replace("{invite}", Addon.INVITE_LINK);
